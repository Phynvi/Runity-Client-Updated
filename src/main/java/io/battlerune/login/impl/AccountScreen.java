...
//			addTooltip("Select avatar");
		...
		client.newBoldFont.drawCenteredString(account.username == null ? "" : Utility.formatName(account.username), 385,
				210 + moveY, 0xff9040, 0);
		...
		client.newBoldFont.drawBasicString("<img=" + rank + "> " + Utility.getRank(rank), 385, 265 + moveY, 0xffffff,
				0);
