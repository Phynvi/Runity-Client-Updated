...
final class SkillConstants {
	 ...
	 */
	static final String[] SKILL_NAMES = { /* 00 */ "Attack", /* 01 */ "Defence", /* 02 */ "Strength",
			/* 03 */ "Hitpoints", /* 04 */ "Ranged", /* 05 */ "Prayer", /* 06 */ "Magic", /* 07 */ "Cooking",
			/* 08 */ "Woodcutting", /* 09 */ "Fletching", /* 10 */ "Fishing", /* 11 */ "Firemaking",
			/* 12 */ "Crafting", /* 13 */ "Smithing", /* 14 */ "Mining", /* 15 */ "Herblore", /* 16 */ "Agility",
			/* 17 */ "Thieving", /* 18 */ "Slayer", /* 19 */ "Farming", /* 20 */ "Runecrafting", /* 21 */ "Hunter",
			/* 22 */ "Construction", };

	/**
	 * All the skills enabled.
	 */
	static final boolean[] SKILLS_ENABLED = { /* 00 */ true, /* 01 */ true, /* 02 */ true, /* 03 */ true, /* 04 */ true,
			/* 05 */ true, /* 06 */ true, /* 07 */ true, /* 08 */ true, /* 09 */ true, /* 10 */ true, /* 11 */ true,
			/* 12 */ true, /* 13 */ true, /* 14 */ true, /* 15 */ true, /* 16 */ true, /* 17 */ true, /* 18 */ true,
			/* 19 */ true, /* 20 */ true, /* 21 */ true, /* 22 */ true, };

	/**
	 * The experience for each level.
	 */
	private static final int[] EXP_FOR_LEVEL = { 0, 83, 174, 276, 388, 512, 650, 801, 969, 1154, 1358, 1584, 1833, 2107,
