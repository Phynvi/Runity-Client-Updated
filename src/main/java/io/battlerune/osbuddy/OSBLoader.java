		...
		MouseListener mouseListener = new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent mouseEvent) {
				...
				if (skillId == 590) {
					...
					stat_exp.setText(
							"Experience: " + NumberFormat.getInstance(Locale.ENGLISH).format(Client.totalExperience));
...
//                System.out.println(Arrays.toString(Client.experience));
				...
				stat_exp.setText(
						"Experience: " + NumberFormat.getInstance(Locale.ENGLISH).format(Client.experience[skillId]));
				if (currentLevel <= 98) {
					stat_xpToLevel.setText("Exp to level(" + (nextLvl) + "): "
							+ NumberFormat.getInstance(Locale.ENGLISH).format(xpForNxt));

					progressBar.setMaximum(100);
					progressBar.setValue(
							(int) ((Client.experience[skillId] - OSBHighscoresParser.EXP_FOR_LEVEL[currentLevel - 1])
									/ (OSBHighscoresParser.EXP_FOR_LEVEL[currentLevel]
											- OSBHighscoresParser.EXP_FOR_LEVEL[currentLevel - 1])
									* 100));
	...
	public OSBLoader() {
		...
		titleBar_settingsButton.setRolloverSelectedIcon(null);
		titleBar_settingsButton.setSelectedIcon(null);
		...
		if (!expanded)
			titleBar_settingsButton.setBounds(titleBar_settingsButton.getX() - 263, titleBar_settingsButton.getY(),
					titleBar_settingsButton.getWidth(), titleBar_settingsButton.getHeight());
		...
		if (!expanded)
			titleBar_cameraButton.setBounds(titleBar_cameraButton.getX() - 263, titleBar_cameraButton.getY(),
					titleBar_cameraButton.getWidth(), titleBar_cameraButton.getHeight());
...
//        titleBar.add(titleBar_cameraButton);
		...
		if (!expanded)
			titleBar_discordButton.setBounds(titleBar_discordButton.getX() - 263, titleBar_discordButton.getY(),
					titleBar_discordButton.getWidth(), titleBar_discordButton.getHeight());
		...
		if (!expanded)
			titleBar_linksButton.setBounds(titleBar_linksButton.getX() - 263, titleBar_linksButton.getY(),
					titleBar_linksButton.getWidth(), titleBar_linksButton.getHeight());
		...
		if (!expanded)
			titleBar_closeButton.setBounds(titleBar_closeButton.getX() - 263, titleBar_closeButton.getY(),
					titleBar_closeButton.getWidth(), titleBar_closeButton.getHeight());
		...
		if (!expanded)
			titleBar_maxButton.setBounds(titleBar_maxButton.getX() - 263, titleBar_maxButton.getY(),
					titleBar_maxButton.getWidth(), titleBar_maxButton.getHeight());
		// titleBar.add(titleBar_maxButton);
		/*
		 * titleBar_maxButton.addActionListener(a -> { Dimension screenSize =
		 * Toolkit.getDefaultToolkit().getScreenSize(); setSize(screenSize.width,
		 * screenSize.height); });
		 */
		...
		if (!expanded)
			titleBar_minButton.setBounds(titleBar_minButton.getX() - 263, titleBar_minButton.getY(),
					titleBar_minButton.getWidth(), titleBar_minButton.getHeight());
		...
		if (!expanded)
			titleBar_collapseButton.setBounds(titleBar_collapseButton.getX() - 263, titleBar_collapseButton.getY(),
					titleBar_collapseButton.getWidth(), titleBar_collapseButton.getHeight());
