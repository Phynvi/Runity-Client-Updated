...
public enum SettingData implements SettingsAction<Client> {
	...
	ITEM_HOVER_INFO("Item tooltip hovers") {
		@Override
		public String name(Client client) {
			return Settings.DRAW_ITEM_HOVERS + setting;
		}

		public boolean status() {
			return Settings.DRAW_ITEM_HOVERS;
		}
	...
	DRAW_SPEC_BUTTON("Special attack button") {
		@Override
		public String name(Client client) {
			return Settings.SPEC_BUTTON + setting;
		}

		public boolean status() {
			return Settings.SPEC_BUTTON;
		}

		@Override
		public void handle(Client client) {
			Settings.SPEC_BUTTON = !Settings.SPEC_BUTTON;
		}
	},

	DRAW_OPPONENT_STATS("Opponent stats") {
		@Override
		public String name(Client client) {
			return Settings.DRAW_OPPONENT_STATS + setting;
		}

		public boolean status() {
			return Settings.DRAW_OPPONENT_STATS;
		}

		@Override
		public void handle(Client client) {
			Settings.DRAW_OPPONENT_STATS = !Settings.DRAW_OPPONENT_STATS;
		}
	},
