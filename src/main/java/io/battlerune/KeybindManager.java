...
public final class KeybindManager {
	...
	private static final int ATTACK_TAB = 0, SKILL_TAB = 1, QUEST_TAB = 2, INVENTORY_TAB = 3, EQUIPMENT_TAB = 4,
			PRAYER_TAB = 5, MAGIC_TAB = 6, FRIENDS_TAB = 8, IGNORE_TAB = 9, CLAN_TAB = 10, WRENCH_TAB = 11,
			EMOTE_TAB = 12, MUSIC_TAB = 13, LOGOUT_TAB = 14;
