...
public enum LoginResponse {
	...
	FAIL(-1), EXCHANGE_DATA(0), DELAY(1), NORMAL(2), INVALID_CREDENTIALS(3, "", "Invalid username or password."),
	...
	MEMBERS_ACCOUNT_REQUIRED(12, "You need a members account to login to this world.",
	...
	SERVER_BEING_UPDATED(14, "The server is being updated.", "Please wait 1 minute and try again."), RECONNECTING(15),
	LOGIN_ATTEMPTS_EXCEEDED(16, "Login attempts exceeded.", "Please wait 1 minute and try again."),
	MEMBERS_ONLY_AREA(17, "You are standing in a members-only area.",
	...
	INSUFFICIENT_PERMSSION(24, "You do not have sufficient permission to access this.",
			"Please try a different world."),
	UNAUTHORIZED_PRIVILEGE(25, "Your account has un-authorized privileges and is",
			"now locked. Please open a ticket on forums to fix."),
	FORUM_REGISTRATION(26, "You have not registered on the forums yet.",
			"Please register on the forums before trying to login."),
